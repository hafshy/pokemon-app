...
class PokemonDetailRespPage extends StatefulWidget {
  final String pokemonUrl;
  const PokemonDetailRespPage({super.key, required this.pokemonUrl});

  @override
  State<PokemonDetailRespPage> createState() => _PokemonDetailRespPageState();
}

class _PokemonDetailRespPageState extends State<PokemonDetailRespPage> {
